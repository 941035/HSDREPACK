		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Repack",
									"targetURL": "#comparkerzhsdrepack-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comparkerzhsdrepack-display": {
								"semanticObject": "comparkerzhsdrepack",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.parker.zhsdrepack",
									"url": sap.ui.require.toUrl("com/parker/zhsdrepack")
								}
							}
						}
					}
